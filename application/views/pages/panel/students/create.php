    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">Create Data Siswa</div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-12">
            <div class="card">
              ...
              <?= form_open_multipart('admin/students_add');?>
              <div class="card-body">
                ...
                <div class="form-group">
                  <label>Kelas</label>
                  <input type="text" class="form-control" name="kelas" value="<?= set_value('kelas'); ?>">
                  <p class="text-danger"><?php echo form_error('kelas'); ?></p>
                </div>
                <div class="form-group">
                  <label>Tgl Lahir</label>
                  <input type="text" class="form-control" name="tgl_lahir" value="<?= set_value('tgl_lahir'); ?>">
