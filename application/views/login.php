...
<head>
  ...
  <title>Login Admin - D-Lemas</title>
  <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('assets/img/d-lemas.png'); ?>">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Login D-Lemas</h4></div>
